...
echo"<form action='account.php' method='post' class='form-horizontal'>
...
$query1="update suppliers set password='$newpas' where email='$up'";
...
$query="select * from suppliers where email='$pf'";
