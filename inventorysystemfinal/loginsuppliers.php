...
<?php 
		...
		$qury="select * from suppliers where email='$email'";
...
<form action="loginsuppliers.php" method="post">
...
<div class="col-sm-9">
  ...
  <a href="login.php" class="text-wite"> Manager Login</a>
</div>
</div>
